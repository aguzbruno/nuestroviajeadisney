...
export const itinerary: ItineraryDay[] = [
  ...
  },
  {
    ...
    parkId: "epcot",
    description:
      "Primer parque. Entrada temprana Disney (~08:30) por All-Star. Prioridad: Guardians of the Galaxy: Cosmic Rewind, Test Track y Soarin' antes del mediodía.",
    activities: [
      {
        time: "06:45",
        title: "Levantarse",
  ...
  },
  {
    ...
    description:
      "Entrada temprana Disney (~08:30) por All-Star. Prioridad: TRON, Seven Dwarfs y Space Mountain antes del mediodía.",
    activities: [
      {
        time: "06:30",
        title: "Levantarse",
